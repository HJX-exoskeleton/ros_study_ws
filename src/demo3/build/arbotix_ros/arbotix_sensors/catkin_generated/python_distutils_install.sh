...
echo_and_run cd "/home/hjx/ros_study_ws/src/demo3/src/arbotix_ros/arbotix_sensors"
...
echo_and_run /usr/bin/env \
    ...
    "/home/hjx/ros_study_ws/src/demo3/src/arbotix_ros/arbotix_sensors/setup.py" \
     \
    build --build-base "/home/hjx/ros_study_ws/src/demo3/build/arbotix_ros/arbotix_sensors" \
    install \
    --root="${DESTDIR-/}" \
